...
# Print to see if we get the right precision
# score_precision_mail_fraud = []
for i in range(1,21):
    score_precision_adult_probation = precision.precisionAtK(actual = actual_adult_probation_adam, predicted=predictd_adult_without_score, k=i)
    # score_precision_mail_fraud.append(score_precision)
    print('Precision@%d is %f' %(i, score_precision_adult_probation))
print()
...
# score_precision_mail_fraud = []
for i in range(1,21):
    score_precision_mail_fraud = precision.precisionAtK(actual = actual_mail_fraud_adam, predicted=predictd_mail_fraud_without_score, k=i)
    # score_precision_mail_fraud.append(score_precision_mail_fraud)
    print('Precision@%d is %f' %(i, score_precision_mail_fraud))
print()
...
print('AP for adult probation: ', score_ap_adult_probation)
print('AP for mail fraud: ', score_ap_mail_fraud)

score_map = (score_ap_adult_probation + score_ap_mail_fraud)/2
print('MAP for two query: ', score_map)
